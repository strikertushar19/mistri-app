  ...
  const sidebarItems = [
    {
      ...
      items: [
        ...
        { name: "Campaign Guidelines", icon: BookOpen, href: "/guidelines" },
        { name: "Important Rules", icon: AlertTriangle, href: "/rules" },
      ]
    },
    {
      title: "Onboarding",
      items: [
        { name: "Onboarding", icon: Users, href: "/onboarding" },
      ]
    },
    {
      title: "Main Menu",
      items: [
        ...
        { name: "Campaigns", icon: FileText, href: "/campaigns" },
                ...
                {projects.map((project) => (
                  ...
                  >
                    <div className={cn(
                      ...
                      project.id === selectedProject.id ? "bg-blue-500" : "bg-gray-300"
                    )}></div>
